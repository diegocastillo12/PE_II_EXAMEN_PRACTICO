...
<%
    ...
    if ("guardarCampo".equals(action)) {
        ...
        if (campo != null && valor != null) {
            try {
                ClsEPeti dato = new ClsEPeti(grupoId, "identificacion_estrategia", campo, valor, usuarioId);
        ...
        try {
            Map<String, String> datos = negocioPeti.obtenerDatosSeccion(grupoId, "identificacion_estrategia");
            
            // Construir JSON manualmente
            StringBuilder json = new StringBuilder();
            json.append("{\"success\": true, \"estrategia\": {");
